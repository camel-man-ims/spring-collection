...
- [템플릿메서드 전략 콜백](#템플릿메서드-전략-콜백)
  - [1. 템플릿 메서드 문제상황](#1-템플릿-메서드-문제상황)
  - [2. 템플릿 메서드 도입](#2-템플릿-메서드-도입)
    - [2-1) 템플릿 메서드 설명](#2-1-템플릿-메서드-설명)
    - [2-2) 익명 내부 클래스](#2-2-익명-내부-클래스)
    - [2-3) 템플릿 메서드의 장점](#2-3-템플릿-메서드의-장점)
    - [2-4) 템플릿 메서드 요약](#2-4-템플릿-메서드-요약)
    - [2-5) 템플릿 메서드의 단점](#2-5-템플릿-메서드의-단점)
  - [3. 전략(Strategy) 패턴](#3-전략strategy-패턴)
